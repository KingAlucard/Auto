                ...
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${userList }" varStatus="status">
					<tr>
						...
						<span><a class="deleteUser" href="/user/userDel.html/${user.id }" onclick="confirm('确认删除嘛？')" userid=${user.id } username=${user.userName }><img src="/statics/images/schu.png" alt="删除" title="删除"/></a></span>
						</td>
					</tr>
